								...
								<div class="hero-unit">
									<div class="row-fluid">
										<div class="span7 marketting-info">
											<h1>Search Friends in Diaspora Social Network</h1>
											<p>Using this functionality in Diaspora API you will be able
											   to search friend by their real name</p>
											<h3>
												<a href="ContactSearch" class="btn btn-primary">Try now</a> 
							...
							<div class="item">
								<div class="hero-unit">
									<div class="row-fluid">
										...
										<div class="span5">
											<img src="bootstrap/img/friendlist.jpg" class="thumbnail" style="width: 300px; height: 300px">
										</div>
									</div>
								</div>
							</div>
